...
public class ActorRunner {
	...
	public static void main(String[] args) {
		...
		String actorName5 = "Kiccha Sudeep";
		String actorName6 = "Yogi";
		...
		String actorName19 = "Soudraya";
		String actorName20 = "Kalpana";
		...
		String actorName42 = "Shilpa Shetty";
		...
		boolean check1 = collection.remove(actorName30);
		System.out.println(check1);

		boolean checkout = collection.contains(actorName30);
