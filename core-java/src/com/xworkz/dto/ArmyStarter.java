...
public class ArmyStarter {
	...
	public static void main(String[] args) {
		...
		ArmyDTO army2 = new ArmyDTO("US", "Navy", "Pentagon", "1.37 million", 1784, "Royal Naval Reserve warfare",
				"White");
		ArmyDTO army3 = new ArmyDTO("China", "Navy", "Ningbo", "2.8 million", 1949, "Naval warfare", "White");
		ArmyDTO army4 = new ArmyDTO("Russia", "Navy", "Saint Petersburg", "1.52 million", 1992, "Naval Warfare",
				"White or black");
